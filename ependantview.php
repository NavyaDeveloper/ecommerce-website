...
<?Php
 $query="SELECT * from ependant where id='{$_GET["id"]}'";
...
?>
   ...
   <form action="ependantviewcart.php?action=add&id=<?php echo $row['id']?> " method="post">
   <div class="container-fluid mt-3">    
  <div class="row">
  <div class="col text-center ">
  <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['image']).'"  class="img-fluid mw-200 h-100 img-thumbnail"> '?>
     </div>
     <div class="col">
